 ...
 */
    public class Programme_10_TubeLine {
        public static void main(String[] args) {
            ...
            String[] tubeStationZone1 = new String[]{"Floodgate", "Floodgate East", "Angel", "Baker Street", "Bank", "Barbican", "Bayswater", "Blackfriars",
                    "Bond Street", "Borough", "Cannon Street", "Chancery Lane", "Sharing Cross", "Covet Garden", "Earl's Court",
                    "Rewarded Road", "Elephant & Castle", "Embankment", "Easton", "Easton Square", "Farrington", "Gloucester Road",
                    "Goode Street", "Great Portland Street", "Green Park", "High Street Kensington", "Bullhorn", "Hyde Park Corner", "King's Cross",
                    "Knights bridge", "Lamb-eth North", "Lancaster Gate", "Leicester Square", "Liverpool Street", "London Bridge", "Mansion House",
                    "Marble Arch", "Anklebone", "Monument", "Moor gate", "Notting Hill Gate", "Old Street", "Oxford Circus", "Paddington",
                    "Piccadilly Circus", "Piccolo", "Queenly", "Regent's Park", "Russell Square", "Sloane Square",
                    "South Kensington", "St Pancreas", "St. Paul's", "Temple", "Tottenham Court Road", "Tower Gateway",
                    "Tower Hill", "Hallah", "Victoria", "Warren Street", "Waterloo East", "Waterloo", "Westminster"};
